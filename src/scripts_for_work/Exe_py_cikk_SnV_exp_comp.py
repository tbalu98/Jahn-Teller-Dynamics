...
#Meymams
A_tr_start = -12771.94511207293
D_tr_start = -17283.23210482362

#Mine
A_tr_start = -18463.2596597052
D_tr_start = -22336.0323358395
...
theory_data_folder = 'results/SnV_results/'

calculation_name = 'SnV_ZPL_shift_Pressure_dep_article'
calculation_name = 'SnV_ZPL_shift'

C_tr_theory_data_1_filename = calculation_name+'_C_transitions.csv'
D_tr_theory_data_1_filename = calculation_name+'_D_transitions.csv'
...
AB_th_fns = [calculation_name+'_A_transitions.csv', calculation_name+'_B_transitions.csv']
