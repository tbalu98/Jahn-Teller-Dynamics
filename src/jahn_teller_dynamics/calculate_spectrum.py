...
def _run_dir() -> Path:
    """Directory where the script is run from (cwd). All paths are relative to this, same as LVC.py and Exe.py."""
    return Path.cwd()
...
def _cli_overrides(args: argparse.Namespace) -> dict:
    ...
    if args.results_folder:
        overrides["results_folder"] = args.results_folder
...
def main() -> int:
    ...
    parser.add_argument("--results-folder", type=str, default="", dest="results_folder", help="Base folder for all output files")
