...
import itertools
import numpy as np
from jahn_teller_dynamics.math_utils.braket_formalism import  operator
...
if TYPE_CHECKING:
    ...
    from jahn_teller_dynamics.math_utils.eigen_solver import EigenSolver
    T = TypeVar('T')
...
class MatrixOperator:
     ...
     def __init__(self, matrix: Union[maths.Matrix, maths.SparseMatrix], name: str = "", subsys_name: str = "", solver: Optional['EigenSolver'] = None):
          ...
          if solver is None:
              ...
              from jahn_teller_dynamics.math_utils.eigen_solver import DenseEigenSolver, SparseEigenSolver
     ...
     def adjoint(self) -> 'MatrixOperator':
          ...
          (dense :class:`~jahn_teller_dynamics.math_utils.maths.Matrix` or CSR
          :class:`~jahn_teller_dynamics.math_utils.maths.SparseMatrix`).
          """
          if isinstance(self.matrix, maths.SparseMatrix):
...
class braket_to_matrix_formalism:
     ...
     def create_MatrixOperator_adjacent_orders(
          ...
          **Important:** :class:`~jahn_teller_dynamics.math_utils.braket_formalism.creator_operator`
