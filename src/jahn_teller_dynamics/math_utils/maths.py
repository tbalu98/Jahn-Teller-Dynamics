...
class SparseMatrix:
    ...
    def calc_eigen_vals_vects(self) -> Tuple[List[Any], List[int], Any]:
        ...
        from jahn_teller_dynamics.math_utils.matrix_mechanics import ket_vector, MatrixOperator
    ...
    def calc_eigen_all_sparse_blocks(
        ...
        from jahn_teller_dynamics.math_utils.matrix_mechanics import ket_vector, MatrixOperator
        from jahn_teller_dynamics.math_utils.maths import SparseColVector
