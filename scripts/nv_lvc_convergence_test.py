#!/usr/bin/env;python3
"""
Convergence;test;of;LVC;eigenvalues;vs;vibrational_quanta_to_dir;for;NV;center.

Uses;NV_center.cfg;as;base;config,;varies;the;unconstrained;per-mode;cutoff;from;1;to;8,
...
;;;;#;Build;argv;to;override;per-mode;phonon;cutoff;and;out_dir
;;;;argv;=;[
